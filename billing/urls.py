...
billing_urls = patterns('billing.views',
                        ...
                        url(r'^bill/client/add/$', v.ClientBillCreate.as_view(), name='client_bill_add'),
                        url(r'^bill/client/(?P<pk>\d+)/update$', v.ClientBillUpdate.as_view(), name='client_bill_update'),
